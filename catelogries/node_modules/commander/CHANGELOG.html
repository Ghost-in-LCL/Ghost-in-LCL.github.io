...
<figure class="highlight js"><table><tr><td class="gutter"><pre><span class="line">1</span><br></pre></td><td class="code"><pre><span class="line"><span class="keyword">if</span> (!program.args.length) ...</span><br></pre></td></tr></table></figure>

<p>a partial replacement is:</p>
<figure class="highlight js"><table><tr><td class="gutter"><pre><span class="line">1</span><br></pre></td><td class="code"><pre><span class="line"><span class="keyword">if</span> (program.rawArgs.length &lt; <span class="number">3</span>) ...</span><br></pre></td></tr></table></figure>
...
<figure class="highlight js"><table><tr><td class="gutter"><pre><span class="line">1</span><br><span class="line">2</span><br><span class="line">3</span><br><span class="line">4</span><br><span class="line">5</span><br></pre></td><td class="code"><pre><span class="line">program</span><br><span class="line">  .option(<span class="string">&#x27;--no-foo&#x27;</span>)</span><br><span class="line">  .on(<span class="string">&#x27;option:no-foo&#x27;</span>, <span class="function">() =&gt;</span> &#123;</span><br><span class="line">    <span class="built_in">console</span>.log(<span class="string">&#x27;removing foo&#x27;</span>);</span><br><span class="line">  &#125;);</span><br></pre></td></tr></table></figure>
...
<figure class="highlight js"><table><tr><td class="gutter"><pre><span class="line">1</span><br><span class="line">2</span><br><span class="line">3</span><br></pre></td><td class="code"><pre><span class="line">program</span><br><span class="line">  .command(<span class="string">&#x27;action1&#x27;</span>, <span class="literal">undefined</span>, &#123; <span class="attr">noHelp</span>: <span class="literal">true</span> &#125;) <span class="comment">// No longer valid</span></span><br><span class="line">  .command(<span class="string">&#x27;action2&#x27;</span>, &#123; <span class="attr">noHelp</span>: <span class="literal">true</span> &#125;) <span class="comment">// Correct</span></span><br></pre></td></tr></table></figure>
